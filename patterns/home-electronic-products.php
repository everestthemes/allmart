<?php
/**
 * Title: Home Electronic Products
 * Slug: allmart/home-electronic-products
 * Categories: allmart
 * Keywords: Home Electronic Products
 *
 * @package  allmart
 */

?>
<!-- wp:group {"metadata":{"name":"Mega Sale Products"},"style":{"spacing":{"padding":{"bottom":"var:preset|spacing|medium"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-bottom:var(--wp--preset--spacing--medium)"><!-- wp:columns {"verticalAlignment":"top"} -->
<div class="wp-block-columns are-vertically-aligned-top"><!-- wp:column {"verticalAlignment":"top","width":"66.66%","style":{"spacing":{"blockGap":"0"}}} -->
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:66.66%"><!-- wp:woocommerce/product-collection {"queryId":11,"query":{"perPage":4,"pages":0,"offset":0,"postType":"product","order":"asc","orderBy":"title","search":"","exclude":[],"inherit":false,"taxQuery":[],"isProductCollectionBlock":true,"featured":false,"woocommerceOnSale":false,"woocommerceStockStatus":["instock","onbackorder"],"woocommerceAttributes":[],"woocommerceHandPickedProducts":[],"filterable":true,"relatedBy":{"categories":true,"tags":true}},"tagName":"div","displayLayout":{"type":"flex","columns":4,"shrinkColumns":true},"dimensions":{"widthType":"fill"},"queryContextIncludes":["collection"],"__privatePreviewState":{"isPreview":false,"previewMessage":"Actual products will vary depending on the page being viewed."},"align":"right"} -->
...
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:33.33%"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/electronic-gadgets-banner.webp","id":457,"dimRatio":0,"customOverlayColor":"#b483cd","isUserOverlayColor":false,"focalPoint":{"x":0.45,"y":0.37},"minHeight":272,"minHeightUnit":"px","contentPosition":"bottom left","isDark":false,"sizeSlug":"full","className":"is-style-image-hover-zoom-effect ","style":{"spacing":{"padding":{"top":"var:preset|spacing|small","bottom":"var:preset|spacing|small","left":"var:preset|spacing|small","right":"var:preset|spacing|small"}},"border":{"radius":"8px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover is-light has-custom-content-position is-position-bottom-left is-style-image-hover-zoom-effect" style="border-radius:8px;padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small);min-height:272px"><img class="wp-block-cover__image-background wp-image-457 size-full" alt="" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/electronic-gadgets-banner.webp" style="object-position:45% 37%" data-object-fit="cover" data-object-position="45% 37%"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#b483cd"></span><div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"spacing":{"blockGap":"8px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:heading {"style":{"elements":{"link":{"color":{"text":"var:preset|color|card"}}}},"textColor":"card"} -->
<h2 class="wp-block-heading has-card-color has-text-color has-link-color"><?php esc_html_e( 'Electronics', 'allmart' ); ?><br><?php esc_html_e( 'Mega Sale', 'allmart' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|card"}}}},"textColor":"card"} -->
<p class="has-card-color has-text-color has-link-color"><strong><?php esc_html_e( 'under $200', 'allmart' ); ?></strong></p>
<!-- /wp:paragraph -->
