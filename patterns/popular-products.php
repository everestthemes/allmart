 ...
 * Slug: onlinestore/popular-products
...
<h3 class="wp-block-heading op-animated animate__fadeInUp" style="margin-bottom:32px"><?php esc_html_e( 'OnlineStore Popular Products', 'onlinestore' ); ?></h3>
<!-- /wp:heading -->
