...
<h2 class="wp-block-heading has-primary-color has-text-color has-link-color has-54-font-size" style="text-transform:uppercase"><?php esc_html_e( 'Sale Off', 'onlinestore' ); ?> <img class="wp-image-1053" style="width: 60px;" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/offer-ribbon.svg" alt=""></h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-secondary-color has-text-color has-link-color" style="text-transform:uppercase"><?php esc_html_e( 'Up to 30%', 'onlinestore' ); ?> </h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<p class="has-primary-color has-text-color has-link-color has-18-font-size" style="font-style:normal;font-weight:600"><?php esc_html_e( 'Find the perfect food for your one-of-a-kind pet', 'onlinestore' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-primary-color has-text-color has-link-color wp-element-button" style="border-radius:12px"><?php esc_html_e( 'Grab the Deal Now', 'onlinestore' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
