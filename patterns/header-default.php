 ...
 * Slug: online-store/header-default
...
<p><?php esc_html_e( '⚡Free Shipping On Orders Over $99', 'online-store' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( '⚡Save flat 50% on Premium Pet Food', 'online-store' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( '⚡30% Off Healthy Pet Diets', 'online-store' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( '⚡Enjoy a special 20% off on your first purchase', 'online-store' ); ?></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-primary-color has-text-color has-link-color has-36-font-size"><a href="<?php echo esc_url( home_url() ); ?>" data-type="page" data-id="16"><?php esc_html_e( 'Online Store', 'online-store' ); ?></a></h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<h4 class="wp-block-heading has-18-font-size" style="font-style:normal;font-weight:500"><?php esc_html_e( 'Start typing and press Enter to search', 'online-store' ); ?></h4>
<!-- /wp:heading -->
