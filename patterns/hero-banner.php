...
<p class="has-primary-color has-text-color has-link-color has-16-font-size" style="font-style:normal;font-weight:600"><?php esc_html_e( '(4.9) Trusted Company', 'online-store' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h2 class="wp-block-heading op-animated animate__fadeInUp delay-1s has-72-font-size" style="margin-top:var(--wp--preset--spacing--x-small);line-height:1.1"><?php esc_html_e( 'Real Pet', 'online-store' ); ?> <img class="wp-image-693" style="width: 120px;" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/hero-header-img.webp" alt=""> <br><?php esc_html_e( 'Food For Healthy Your', 'online-store' ); ?> <img class="wp-image-696" style="width: 64px;" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/hero-header-img-food.webp" alt=""> <?php esc_html_e( 'Pets', 'online-store' ); ?></h2>
<!-- /wp:heading -->
