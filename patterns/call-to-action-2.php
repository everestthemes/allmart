 ...
 * Slug: onlinestore/call-to-action-2
...
<p class="has-foreground-color has-text-color has-link-color has-18-font-size"><?php esc_html_e( 'Your first repeat delivery order! Use code ', 'onlinestore' ); ?> <strong><?php esc_html_e( 'BIGSALE2025', 'onlinestore' ); ?></strong> <?php esc_html_e( 'at checkout', 'onlinestore' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"style":{"elements":{"link":{"color":{"text":"var:preset|color|foreground"}}}},"textColor":"foreground","fontSize":"30"} -->
<h2 class="wp-block-heading has-foreground-color has-text-color has-link-color has-30-font-size"><?php esc_html_e( '20% Off ! Your first repeat delivery order of $95', 'onlinestore' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-button is-style-fill sm-align-left"><a class="wp-block-button__link has-card-color has-primary-background-color has-text-color has-background has-link-color wp-element-button" style="border-radius:100px;font-style:normal;font-weight:600;text-transform:uppercase"><?php esc_html_e( 'Shop Now', 'onlinestore' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
