...
?>
<!-- wp:group {"metadata":{"name":"Main Product Filter"},"style":{"spacing":{"blockGap":"24px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:woocommerce/product-filters {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}}} -->
<div class="wp-block-woocommerce-product-filters wc-block-product-filters" style="--wc-product-filters-text-color:#111;--wc-product-filters-background-color:#fff;--wc-product-filter-block-spacing:var(--wp--preset--spacing--small)"><!-- wp:heading {"style":{"margin":{"top":"0","bottom":"0"},"spacing":{"margin":{"top":"0","bottom":"0"}}},"fontSize":"24"} -->
<h2 class="wp-block-heading has-24-font-size" style="margin-top:0;margin-bottom:0">Filters</h2>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-product-filter-price"><!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"bottom":"0.625rem","top":"0"}}},"fontSize":"24"} -->
<h3 class="wp-block-heading has-24-font-size" style="margin-top:0;margin-bottom:0.625rem">Price</h3>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-product-filter-rating"><!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"bottom":"0.625rem","top":"0"}}},"fontSize":"24"} -->
<h3 class="wp-block-heading has-24-font-size" style="margin-top:0;margin-bottom:0.625rem">Rating</h3>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-product-filter-attribute"><!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"bottom":"0.625rem","top":"0"}}},"fontSize":"24"} -->
<h3 class="wp-block-heading has-24-font-size" style="margin-top:0;margin-bottom:0.625rem">Color</h3>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-product-filter-status"><!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"bottom":"0.625rem","top":"0"}}},"fontSize":"24"} -->
<h3 class="wp-block-heading has-24-font-size" style="margin-top:0;margin-bottom:0.625rem">Status</h3>
<!-- /wp:heading -->
