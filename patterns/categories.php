...
<div class="wp-block-group" style="border-radius:0px"><!-- wp:group {"className":"op-animated animate__fadeIn","layout":{"type":"constrained"}} -->
<div class="wp-block-group op-animated animate__fadeIn"><!-- wp:image {"id":934,"width":"172px","sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"12px"}}} -->
<figure class="wp-block-image size-full is-resized has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/dog.webp" alt="" class="wp-image-934" style="border-radius:12px;width:172px"/></figure>
<!-- /wp:image -->
...
<!-- wp:group {"className":"op-animated animate__fadeIn","layout":{"type":"constrained"}} -->
<div class="wp-block-group op-animated animate__fadeIn"><!-- wp:image {"id":938,"width":"172px","sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"12px"}}} -->
<figure class="wp-block-image size-full is-resized has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/cat.webp" alt="" class="wp-image-938" style="border-radius:12px;width:172px"/></figure>
<!-- /wp:image -->
...
<!-- wp:group {"className":"op-animated animate__fadeIn","layout":{"type":"constrained"}} -->
<div class="wp-block-group op-animated animate__fadeIn"><!-- wp:image {"id":937,"width":"172px","sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"12px"}}} -->
<figure class="wp-block-image size-full is-resized has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/fish.webp" alt="" class="wp-image-937" style="border-radius:12px;width:172px"/></figure>
<!-- /wp:image -->
...
<!-- wp:group {"className":"op-animated animate__fadeIn","layout":{"type":"constrained"}} -->
<div class="wp-block-group op-animated animate__fadeIn"><!-- wp:image {"id":939,"width":"172px","sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"12px"}}} -->
<figure class="wp-block-image size-full is-resized has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/bird.webp" alt="" class="wp-image-939" style="border-radius:12px;width:172px"/></figure>
<!-- /wp:image -->
...
<!-- wp:group {"className":"op-animated animate__fadeIn","layout":{"type":"constrained"}} -->
<div class="wp-block-group op-animated animate__fadeIn"><!-- wp:image {"id":935,"width":"172px","sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"12px"}}} -->
<figure class="wp-block-image size-full is-resized has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/horse.webp" alt="" class="wp-image-935" style="border-radius:12px;width:172px"/></figure>
<!-- /wp:image -->
...
<!-- wp:group {"className":"op-animated animate__fadeIn","layout":{"type":"constrained"}} -->
<div class="wp-block-group op-animated animate__fadeIn"><!-- wp:image {"id":936,"width":"172px","sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"12px"}}} -->
<figure class="wp-block-image size-full is-resized has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/turtle.webp" alt="" class="wp-image-936" style="border-radius:12px;width:172px"/></figure>
<!-- /wp:image -->
