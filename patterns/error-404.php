...
<h1 class="wp-block-heading has-text-align-center has-90-font-size" style="font-style:normal;font-weight:800"><?php esc_html_e( '404', 'online-store' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:heading {"textAlign":"center","level":1} -->
<h1 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Oops! That page can’t be found.', 'online-store' ); ?></h1>
<!-- /wp:heading -->
...
<p class="has-text-align-center has-18-font-size"><?php esc_html_e( 'We’re really sorry but we can’t seem to find the page you were looking for.', 'online-store' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a href="<?php echo esc_url( home_url() ); ?>" class="wp-block-button__link wp-element-button" style="border-radius:12px"><?php esc_html_e( 'Go to Homepage', 'online-store' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></main>
<!-- /wp:group -->
